...
- **媒体播放**：点击音频/视频文件即播放，支持 HTTP Range 断点续播与进度拖动；音频支持 mp3/wav/ogg/m4a/flac/aac/webm，视频支持 mp4/webm/mkv/mov/m4v/avi（纯音频 webm 自动以音频方式播放）
- **图片相册**：图片（jpg/png/gif/webp/bmp/svg/avif）以全屏相册查看，支持滚轮/双击/按钮/双指缩放，上一张/下一张（按钮/键盘/滑动）
